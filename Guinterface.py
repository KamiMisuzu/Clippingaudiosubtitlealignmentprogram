...
def start():
    ...
    # data1= Lablemanagement(informationWindow,text="当前目录:"+g1.data["config_directory"],type='grid',x=1,y=3,foreground="red")
    ...
    # for i in range(50):
    #     button = ttk.Button(defcanvase, text=f"按钮{i}",width=500)
    #     defcanvase.create_window(200, 20 + i * 30, window=button)
    # defcanvase.bind("<Configure>", update_scrollregion)

    # 按钮
    # button1 = Buttonmanagement(selectFrame,x=0,text="设置",width=100,height=46,font="黑体",fg="red")
